# The name of this view in Looker is "Predicted Data"
view: predicted_data {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `looker_data.Predicted_Data`
    ;;
  ...
  dimension: new_batch_id {
    type: string
    sql: ${TABLE}.New_Batch_ID ;;
  }
  ...
  dimension: predicted_giveaway {
    type: number
    sql: ${TABLE}.Predicted_Giveaway ;;
  }
